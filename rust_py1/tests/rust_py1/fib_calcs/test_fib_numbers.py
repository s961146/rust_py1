...
from rust_py1.fib_calcs.fib_number import recurring_fibonacci_number
from rust_py1.fib_calcs.fib_numbers import calculate_numbers
from rust_py1.tests import rust_py1

class Test(TestCase):
    @patch("rust_py1.fib_calcs.fib_number."
    ...
    def test_calculate_numbers(self, mock_fib_calc):
        ...
        self.assertEqual(2, len(mock_fib_calc.calc_args_list))
